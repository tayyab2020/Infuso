...
const PRODUCTS = {
  aether: {
    priceOld: 4500,
    imageUrl: '/products/aether.png',
    hoverImageUrl: '/products/aether_box.png',
    editorialTallImageUrl: '/products/aether_dark.png',
    editorialWideImageUrl: '/products/aether_slate.jpg',
  ...
  aria: {
    priceOld: 4500,
    imageUrl: '/products/aria.png',
    hoverImageUrl: '/products/aria_box.png',
    editorialTallImageUrl: '/products/aria_hands.png',
    editorialWideImageUrl: '/products/aria_citrus.jpg',
  ...
  oudor: {
    priceOld: 4500,
    imageUrl: '/products/oudor.png',
    hoverImageUrl: '/products/oudor_box.png',
    editorialTallImageUrl: '/products/oudor_wood.png',
    editorialWideImageUrl: '/products/oudor_rocks.jpg',
